...
mod tests {
    ...
    // Function to check if hardware is available for testing
    fn hardware_available() -> bool {
        let has_hardware = PciDevice::scan()
            .iter()
            .any(|id| PciDevice::open(*id).is_ok() && luwen_ref::open(*id).is_ok());

        if !has_hardware {
            println!("Test SKIPPED: No suitable hardware found for testing");
        }
    ...
    fn test_aligned_register_access() {
        ...
        fixture
            .raw_device
            .write32(fixture.aligned_addr, 0xfaca)
            .unwrap();
    ...
    #[test]
    #[ignore = "Requires hardware"]
    fn test_unaligned_register_access() {
        if !hardware_available() {
            return;
        }
    ...
    #[test]
    #[ignore = "Requires hardware"]
    fn test_sequential_pattern_reads() {
        if !hardware_available() {
            return;
        }
    ...
    #[test]
    #[ignore = "Requires hardware"]
    fn test_aligned_block_operations() {
        if !hardware_available() {
            return;
        }
    ...
    #[test]
    #[ignore = "Requires hardware"]
    fn test_unaligned_block_operations() {
        if !hardware_available() {
            return;
        }
    ...
    #[test]
    #[ignore = "Requires hardware"]
    fn test_sequential_pattern_block_operations() {
        if !hardware_available() {
            return;
        }
